...
class FormularioContainer extends ConsumerWidget {
  ...
  Widget build(
    ...
    final createAccountFunction =
        ref.read(createUserSesionProvider); // Obtener la función postUser
    return Container(
  ...
  TextFormField _buildTextFormField(
    ...
    return TextFormField(
      ...
      decoration: InputDecorations2.inputDecoration2(
        //*Este es el textFormfield que cree para poder usar este.
        hintText:
            "", //Es el texto que aparece luego de hacer click en el textformfield
        labelText:
            label, //Esto es lo que aparece en la parte superior del textformfield
        prefixIcon:
      ...
      validator:
          validator, //*lo que escribio se lo devolverá a una funcion que lo validará.
      focusNode: focusNode,
      controller: controller,
      onTapOutside: (event) {
        focusNode
            .unfocus(); //*Esto es para que se cierre el form si toco afuera de la pantala
      },
    );
  }
  ...
  Widget _buildCreateAccountButton(BuildContext context,
      Future<void> Function(String, String, String) createAccountFunction) {
    ...
    return MaterialButton(
      ...
      onPressed: () async {
        final name =
            nameController.text.trim(); //*para no agergar espacios de mas
