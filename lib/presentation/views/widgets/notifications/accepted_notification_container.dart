...
import 'package:studenthive/presentation/views/home_views/notificatino_view.dart';

//* NOTIFICACIÓN DE SOLICITUDES ACEPATADAS
class AcceptedNotificationContainer extends StatelessWidget {
  final String titleNotification;
  final User user;

  const AcceptedNotificationContainer({super.key, required this.titleNotification, required this.user,});
